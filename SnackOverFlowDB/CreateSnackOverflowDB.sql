...
AS
	...
	SELECT @PRODUCT_ORDER_ID, USER_CART_LINE.PRODUCT_ID, PRODUCT.NAME, USER_CART_LINE.QUANTITY, USER_CART_LINE.GRADE_ID,
		PRODUCT_GRADE_PRICE.PRICE, EXP(LOG(PRODUCT_GRADE_PRICE.PRICE)+LOG(TOTAL_DISCOUNT.SCALED_PRODUCT_DISCOUNT)+LOG(TOTAL_DISCOUNT.SCALED_CATEGORY_DISCOUNT)) + TOTAL_DISCOUNT.FLAT_PRODUCT_DISCOUNT + TOTAL_DISCOUNT.FLAT_CATEGORY_DISCOUNT AS UNIT_DISCOUNT
	FROM USER_CART_LINE
	INNER JOIN PRODUCT
