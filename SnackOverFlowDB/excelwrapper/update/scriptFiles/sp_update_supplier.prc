...
BEGIN
UPDATE supplier
SET USER_ID = @new_USER_ID, IS_APPROVED = @new_IS_APPROVED, APPROVED_BY = @new_APPROVED_BY, FARM_NAME = @new_FARM_NAME, FARM_CITY = @new_FARM_CITY,
FARM_STATE = @new_FARM_STATE, FARM_TAX_ID = @new_FARM_TAX_ID
