...
[DELIVERY_CHARGE_PER_UNIT][DECIMAL](5,2) NOT NULL,
...
VALUES('Apple', 'It is a fruit', 0.5, 1, 'Kg', 0.5)
GO

print '' print '*** inserting data into PRODUCT_LOT'
GO
INSERT [dbo].[PRODUCT_LOT]([WAREHOUSE_ID], [SUPPLIER_ID], [LOCATION_ID], [PRODUCT_ID], [SUPPLY_MANAGER_ID], [QUANTITY], [AVAILABLE_QUANTITY], [DATE_RECEIVED], [EXPIRATION_DATE])
VALUES(10000, 10000, 10000, 10000, 10000, 100, 100, '01-02-17 12:30:30', '01-25-17 12:30:30')
GO
...
VALUES
('', '', '', NULL, '', 0, 'b55e3f7c1255a049ef191c9189bcf4893de517714d14e417d331e8a6fb604f6b', 'ADMIN', 'ADMIN', 1),
('Test', 'User', '1234567890', 1, 'user@test.com', 0, 'b55e3f7c1255a049ef191c9189bcf4893de517714d14e417d331e8a6fb604f6b', 'ADMIN', 'testUser', 1)
GO

INSERT INTO USER_ADDRESS (USER_ADDRESS_ID, USER_ID, ADDRESS_LINE_1, ADDRESS_LINE_2, CITY, STATE, ZIP)
VALUES
	(1, 10001, '102 Somewhere Rd', ' ', 'Anywhere', 'IA', '52525')
GO

INSERT INTO [EMPLOYEE] ([USER_ID], [SALARY], [ACTIVE], [DATE_OF_BIRTH])
VALUES
	(10001, 50.0, 1, '1990-12-25')
GO
