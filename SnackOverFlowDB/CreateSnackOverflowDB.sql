...
AS
	BEGIN
		INSERT INTO COMMERCIAL_INVOICE
			(COMMERCIAL_ID, INVOICE_DATE, SUB_TOTAL, TAX_AMOUNT, TOTAL, AMOUNT_PAID, ORDER_ID)
		VALUES
			(@COMMERCIAL_ID, @INVOICE_DATE, @SUB_TOTAL, @TAX_AMOUNT, @TOTAL, @AMOUNT_PAID, @ORDER_ID)
		SELECT SCOPE_IDENTITY()
	END
...
AS
	BEGIN
		SELECT COMMERCIAL_INVOICE_ID, COMMERCIAL_INVOICE.COMMERCIAL_ID, INVOICE_DATE, SUB_TOTAL, TAX_AMOUNT, TOTAL, AMOUNT_PAID, APPROVED, COMMERCIAL_INVOICE.ACTIVE
		FROM COMMERCIAL_INVOICE
