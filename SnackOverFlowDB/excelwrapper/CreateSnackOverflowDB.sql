...
GO
ALTER TABLE dbo.PRODUCT_LOT
ADD CONSTRAINT PRODUCT_LOT_GRADE_def
DEFAULT 'Not Inspected' FOR GRADE
GO
...
AS
BEGIN
SELECT PRODUCT_LOT_ID, WAREHOUSE_ID, SUPPLIER_ID, LOCATION_ID, PRODUCT_ID, SUPPLY_MANAGER_ID, QUANTITY,
 AVAILABLE_QUANTITY, DATE_RECEIVED, EXPIRATION_DATE,GRADE
FROM product_lot
WHERE PRODUCT_LOT_ID = @PRODUCT_LOT_ID
END
GO
...
BEGIN
SELECT PRODUCT_LOT_ID, WAREHOUSE_ID, SUPPLIER_ID, LOCATION_ID, PRODUCT_ID, SUPPLY_MANAGER_ID, QUANTITY,
 AVAILABLE_QUANTITY, DATE_RECEIVED, EXPIRATION_DATE,GRADE,PRICE
FROM product_lot
END
GO
...
AS
BEGIN
INSERT INTO SUPPLIER_INVENTORY (AGREEMENT_ID, QUANTITY)
VALUES
(@AGREEMENT_ID, @QUANTITY)
END
GO
