...
CREATE TABLE [dbo].[COMMERCIAL_INVOICE_LINE] (
	...
	CONSTRAINT	[PK_COMMERCIAL_INVOICE_LINE] PRIMARY KEY([COMMERCIAL_INVOICE_ID] ASC, [PRODUCT_LOT_ID] ASC)
)
GO
...
print '' print '*** Creating Foreign Key COMMERCIAL_INVOICE_SUPPLIER_ID'
GO
...
print '' print '*** Creating Foreign Key COMMERCIAL_INVOICE_LINE_SUPPLIER_INVOICE_ID'
GO
...
GO
ALTER TABLE [dbo].[COMMERCIAL_INVOICE_LINE] WITH NOCHECK
	ADD CONSTRAINT[fk_COMMERCIAL_INVOICE_LINE_PRODUCT_LOT_ID] FOREIGN KEY ([PRODUCT_LOT_ID])
	REFERENCES [dbo].[PRODUCT_LOT](PRODUCT_LOT_ID)
	ON UPDATE CASCADE
	ON DELETE CASCADE
GO
...
AS
	BEGIN
		INSERT INTO COMMERCIAL_INVOICE_LINE
			(COMMERCIAL_INVOICE_ID, PRODUCT_LOT_ID, QUANTITY_SOLD, PRICE_EACH, ITEM_DISCOUNT, ITEM_TOTAL)
		VALUES
			(@COMMERCIAL_INVOICE_ID, @PRODUCT_LOT_ID, @QUANTITY_SOLD, @PRICE_EACH, @ITEM_DISCOUNT, @ITEM_TOTAL)
		RETURN @@ROWCOUNT
	END
...
AS
	BEGIN
		SELECT COMMERCIAL_INVOICE_ID, PRODUCT_LOT_ID, QUANTITY_SOLD, PRICE_EACH, ITEM_DISCOUNT, ITEM_TOTAL
