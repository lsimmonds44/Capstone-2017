...
[CUSTOMER_ID][INT] NOT NULL,
[ORDER_TYPE_ID][NVARCHAR](250) NOT NULL,
[ADDRESS_TYPE][NVARCHAR] NOT NULL,
[DELIVERY_TYPE_ID][NVARCHAR](50) NOT NULL,
...
print '' print '*** Creating Foreign Key APP_USER_PERFERRED_ADDRESS_ID'
GO
ALTER TABLE [dbo].[APP_USER] with nocheck
  ADD CONSTRAINT[fk_APP_USER_PERFERRED_ADDRESS_ID] FOREIGN KEY ([PERFERRED_ADDRESS_ID])
...
IF EXISTS(SELECT 1 FROM master.dbo.sysdatabases WHERE name = 'BillsPC')
BEGIN
  Print '' print  ' *** dropping database BillsPC'
  DROP DATABASE SnackOverflowDB
End
GO
print '' print '*** creating database SnackOverflowDB'
...
[LAST_NAME][NVARCHAR](100),
[PHONE][NVARCHAR](15) NOT NULL,
[PERFERRED_ADDRESS_ID][INT] NOT NULL,
[E_MAIL_ADDRESS][NVARCHAR](50) NOT NULL,
[E_MAIL_PREFERENCES][BIT] NOT NULL,
[PASSWORD_HASH][NVARCHAR](64) NOT NULL,
[PASSWORD_SALT][NVARCHAR](64) NOT NULL,
