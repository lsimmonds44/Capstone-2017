USE [SnackOverflowDB]
GO
IF EXISTS(SELECT * FROM sys.objects WHERE type = 'P' AND  name = 'sp_retrieve_expired_product_lot_list')
BEGIN
Drop PROCEDURE sp_retrieve_expired_product_lot_list
Print '' print  ' *** dropping procedure sp_retrieve_expired_product_lot_list'
End
GO
